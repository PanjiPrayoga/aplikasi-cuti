...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti - <?php echo $pagedesc ?></title>

	<link href="libs/images/hoki.png" rel="icon" type="images/x-icon">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<div class="float-right">&nbsp;<strong>Siatem Informasi Pengajuan Cuiti</strong></div>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<img src="libs/images/hoki1.png" height="50"><br></br>
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Approval Cuti Pegawai") {
								echo '<li><a href="approval_cuti_pegawai.php" class="active">Approval Cuti Pegawai</a></li>';
							} else {
								echo '<li><a href="approval_cuti_pegawai.php">Approval Cuti Pegawai</a></li>';
							}

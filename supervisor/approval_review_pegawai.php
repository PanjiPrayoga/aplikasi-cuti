...
// deskripsi halaman
$pagedesc = "Approval Cuti Pegawai";
$menuparent = "approval";
...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Approval Cuti Pegawai</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
		...
		<div class="row">
			<div class="col-lg-12">
				<form class="form-horizontal" name="cuti" action="approval_update_pegawai.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">

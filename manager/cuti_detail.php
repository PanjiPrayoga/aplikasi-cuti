	...
	<div id="section-to-print">
		...
		<div><br />
			<table width="100%">
				...
				<tr>
					<td width="20%"><b>File Pendukung</b></td>
					<td width="2%"><b>:</b></td>
					<td width="38%">
						<?php
						// Tampilkan tautan ke file pendukung jika ada
						if (!empty($result['file_pendukung'])) {
							echo $result['file_pendukung'];
						} else {
					...
					<td width="20%">
						...
						// Tampilkan tautan ke file pendukung jika ada
						if (!empty($result['file_pendukung'])) {
							$fileLink = "../uploads_file_pendukung/" . $result['file_pendukung'];

				...
				<form class="form-horizontal" name="cuti" action="cuti_insert.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="spv">Supervisor</label>
								<div class="col-sm-4">
									<select name="spv" id="spv" class="form-control" required>
										...
										$dataLeader = isset($result['npp']) ? $result['npp'] : '';
										while ($leaderData = mysqli_fetch_array($myQry)) {
											$cek = ($leaderData['npp'] == $dataLeader) ? "selected" : "";
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="file" name="file_pendukung" class="form-control" accept=".pdf, .doc, .docx">

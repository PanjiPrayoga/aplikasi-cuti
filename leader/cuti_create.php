                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" name="now" class="form-control" value="<?= htmlspecialchars($now); ?>" required>
                                    <input type="hidden" name="npp" class="form-control" value="<?= htmlspecialchars($npp); ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="spv" id="spv" class="form-control" required>
                                        ...
                                        while ($leaderData = mysqli_fetch_array($myQry)) {
                                            $selected = ($leaderData['npp'] == $npp) ? "selected" : "";
                                            echo "<option value='" . htmlspecialchars($leaderData['npp']) . "' $selected>" . htmlspecialchars($leaderData['nama_emp']) . "</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">Dokumen Pendukung</label>
                                <div class="col-sm-4">
                                    <input type="file" name="file_pendukung" class="form-control" accept=".pdf, .doc, .docx" required>
                                    <small class="text-muted">File dengan format .pdf, .doc, atau .docx</small>
                                </div>
                            </div>
                        </div>
